...
export function FlowBuilderDrawer({ opened, onClose, initialData, onSave, loading }: FlowBuilderDrawerProps) {
    ...
    const InfoPanel = () => (
        <Stack p="md" gap="lg" className="h-full overflow-y-auto">
            <Box>
                <Group gap="xs" mb="md">
    ...
    const DesignPanel = () => (
        <Box className="h-full flex flex-col relative overflow-hidden bg-gray-50/50 dark:bg-zinc-900/50">
            ...
            <Box p="md" className="border-b border-gray-200 bg-white/50 backdrop-blur-sm z-10 flex justify-between items-center sticky top-0 shrink-0">
                <Group>
            ...
            <Box className="flex-1 w-full overflow-auto relative bg-gray-50/50 dark:bg-zinc-900/50">
