...
import { TextInput as MantineTextInput, Paper, Stack, Group, Box, Text } from '@mantine/core';
...
export const TextInput: React.FC<TextInputProps> = ({ label, value, onChange, placeholder, required, error }) => {
    return (
        <Paper
            p="md"
            radius="20px"
