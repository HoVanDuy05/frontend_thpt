...
import { Checkbox as MantineCheckbox, Paper, Stack, Group, Box, Text, SimpleGrid } from '@mantine/core';
...
export const CheckboxInput: React.FC<CheckboxInputProps> = ({ label, value, onChange, options, required, error }) => {
    return (
        <Paper
            p="md"
            radius="20px"
        ...
        >
            <Stack gap="sm">
                ...
                <MantineCheckbox.Group value={value} onChange={onChange} error={error}>
