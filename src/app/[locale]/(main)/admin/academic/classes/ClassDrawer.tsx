...
import { Drawer, Stack, TextInput, Button, Group, LoadingOverlay, Select, NumberInput, Textarea } from "@mantine/core";
...
export function ClassDrawer({ opened, onClose, lopNamModel }: ClassDrawerProps) {
    ...
    const { data: teachers } = AppQuery.user.useList({ role: 'GIAO_VIEN' });
