            ...
            actions={
                ...
                >
                    <Group gap={6} wrap="nowrap">
                        <IconPlus size={18} />
                        <span className="hidden sm:inline">Thêm Giáo viên</span>
                    </Group>
                </AppButton>
            }
        >
                ...
                {isLoading ? (
                    ...
                    <Stack align="center" py={100} gap="lg">
                        ...
                        <Stack gap={4} align="center">
                            <Text fw={700} size="lg">Chưa có dữ liệu giáo viên</Text>
                            <Text size="sm" c="dimmed">Bắt đầu bằng việc thêm giáo viên mới vào hệ thống</Text>
                        </Stack>
                        <AppButton
                            variant="light"
