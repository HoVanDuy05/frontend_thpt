...
export const AppQuery = {
    ...
    calendar: {
        ...
        useMySchedule: (params?: { from?: string; to?: string; namHocId?: number }, options?: AppQueryOptions<"getMySchedule">) =>
            useAppQuery({ url: { baseUrl: "/calendar/student/my-schedule", queryParams: params }, options }),
    },
    assessment: {
